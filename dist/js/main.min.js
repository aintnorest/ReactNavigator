...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	var initialScene = { a: { state: 1, z: 1 }, b: { state: 20, z: 1 }, c: { state: 1, z: 1 } };
	//
	var Navigator = __webpack_require__(176)({ React: _reactAddons2["default"], TransitionMotion: _reactMotion.TransitionMotion, spring: _reactMotion.spring });
	
	var Test = __webpack_require__(179)({ React: _reactAddons2["default"] });
	var testOne = _reactAddons2["default"].createElement(Test, { key: "1", top: "0", background: "blue", content: "TESTER 1" });
	var testTwo = _reactAddons2["default"].createElement(Test, { key: "2", top: "50", background: "green", content: "TESTER 2" });
	var testThree = _reactAddons2["default"].createElement(Test, { key: "3", top: "100", background: "purple", content: "TESTER 3" });
	
	var sceneConfigurations = {
	    a: {
	        Enter: {
	        ...
	        Styles: function Styles(val) {
	            return { opacity: (0, _reactMotion.spring)(val.state), zIndex: val.z };
	        },
	    ...
	    b: {
	        ...
	        Styles: function Styles(val) {
	            return { x: (0, _reactMotion.spring)(val.state), zIndex: val.z };
	        },
	        Element: function Element() {
	            return testTwo;
	        }
	...
	_reactAddons2["default"].render(_reactAddons2["default"].createElement(Navigator, { sceneConfigurations: sceneConfigurations, initialScene: initialScene }), document.body);
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedStateMixin = __webpack_require__(5);
	...
	var cx = __webpack_require__(172);
	var cloneWithProps = __webpack_require__(166);
	var update = __webpack_require__(173);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(174);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties = __webpack_require__(197)["default"];
	
	var _Object$keys = __webpack_require__(198)["default"];
	
	var navigatorFactory = function navigatorFactory(_ref) {
	    var React = _ref.React;
	    var TransitionMotion = _ref.TransitionMotion;
	    ...
	    return React.createClass({
	        ...
	        getInitialState: function getInitialState() {
	            return { elements: {}, loading: 0, modal: React.createElement("span", null), modalVisible: 0 };
	        },
	        ...
	        getStyles: function getStyles() {
	            ...
	            var configs = {};
	            _Object$keys(this.state.elements).forEach(function (key) {
	                configs[key] = _this.props.sceneConfigurations[key].Styles(_this.state.elements[key]);
	            });
	            return configs;
	        },
	        ...
	        willLeave: function willLeave(key, style) {
	        ...
	        render: function render() {
	            ...
	            return React.createElement(TransitionMotion, {
	                ...
	                willLeave: this.willLeave }, function (interpolatedStyles) {
	                return React.createElement("div", null, _Object$keys(interpolatedStyles).map(function (key) {
	                    var style = _objectWithoutProperties(interpolatedStyles[key], []);
	                    ...
	                    return React.createElement("div", { key: key, style: s }, _this2.props.sceneConfigurations[key].Element());
	                }), React.createElement("div", { style: { opacity: _this2.state.modalVisible, transition: "opacity .2s ease-in-out", width: "100%", height: "100%", background: "rgba(42,73,91,0.8)", zIndex: _this2.state.modalVisible ? "25" : "-2", position: "absolute", top: "0", left: "0" } }, _this2.state.modal), React.createElement("div", { style: { opacity: _this2.state.loading, transition: "opacity .2s ease-in-out", width: "100%", height: "100%", background: "rgba(42,73,91,0.8)", zIndex: _this2.state.loading ? "30" : "-2", position: "absolute", top: "0", left: "0" } }, React.createElement("img", { style: { width: "100px", height: "100px", marginLeft: "462px", marginTop: "250px", marginBottom: "10px" }, src: "./assets/loading.gif" }), React.createElement("div", { style: { fontSize: "25px", textAlign: "center", color: "#F4F4F4" } }, "Loading...")));
	            });
	        },
	
	        nav: function nav(currContext) {
	            var target = currContext;
	            return {
	                push: function push(newScene) {
	                    target.history.push(cloneObject(target.state.elements));
	                    target.setState({ elements: newScene, modalVisible: 0, modal: React.createElement("span", null) });
	                },
	                pop: function pop() {
	                    if (target.history.length == 0) return;
	                    var newScene = target.history.pop();
	                    target.setState({ elements: newScene });
	                },
	                modalOn: function modalOn(modal) {
	                    target.setState({ modal: modal, modalVisible: 1 });
	                },
	                modalOff: function modalOff() {
	                    target.setState({ modalVisible: 0, modal: React.createElement("span", null) });
	                },
...
/***/ function(module, exports) {
	...
	var testFactory = function testFactory(_ref) {
	    var React = _ref.React;
	    ...
	    return React.createClass({
	        ...
	        render: function render() {
	            return React.createElement("div", { onClick: this.props.click, style: { width: "50px", height: "50px", position: "absolute", top: this.props.top, background: this.props.background } }, this.props.content);
	        }
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components2 = __webpack_require__(182);
	
	var _components3 = _interopRequireDefault(_components2);
	
	var _reorderKeys = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noVelocity = __webpack_require__(183);
	
	var _noVelocity2 = _interopRequireDefault(_noVelocity);
	
	var _hasReachedStyle = __webpack_require__(184);
	...
	var _animationLoop = __webpack_require__(186);
	
	var _animationLoop2 = _interopRequireDefault(_animationLoop);
	
	var _zero = __webpack_require__(189);
	
	var _zero2 = _interopRequireDefault(_zero);
	
	var _updateTree = __webpack_require__(190);
	
	var _deprecatedSprings2 = __webpack_require__(192);
	
	var _deprecatedSprings3 = _interopRequireDefault(_deprecatedSprings2);
	
	var _stripStyle = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _presets = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(206).Object.keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(203)('keys', function($keys){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(204)
	    , fn   = (__webpack_require__(206).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(207)(function(){ fn(1); }), 'Object', exp);
	};
